								...
								<div class="modal-dialog">
									<div class="modal-content">
													<div class="modal-header">
														...
														<h3 align="center" class="modal-title" id="myModalLabel">Ingreso de Efectivo</h3>
													</div>
										<div class="panel-body">
										<div class="row" align="center">                                       
											...
											<strong>Hola! <?php echo $cajero_nombre; ?></strong><br>
												...
												<h4><pre><h1 class="text-success" align="center"><?php echo $s.' '.formato($caja); ?></h1></pre>	</h4>
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                              ...
                              <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
										  <?php 
											$sql=mysql_query("SELECT * FROM resumen WHERE fecha between '$fechai' AND '$fechaf' and consultorio='$id_consultorio'".$where);
											while($row=mysql_fetch_array($sql)){
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td><?php echo fecha($row['fecha']).' '.date($row['hora']); ?></td>
                                            ...
                                            <td class="center">
											<a href="../detalle/index.php?detalle=<?php echo $url; ?>"  class="btn btn-info btn-sm" title="Detalle">
