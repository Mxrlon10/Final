				...
				<form name="form2" action="" method="post">
                                    ...
                                    <datalist id="browsers">
                                        <?php
                                            ...
                                            WHERE date_format(fecha,'%Y%m%d')=date_format(curdate(),'%Y%m%d') AND consultas_medicas.status='PENDIENTE' AND consultas_medicas.id_paciente AND consultas_medicas.consultorio='$id_consultorio' ORDER BY consultas_medicas.id DESC");				
                                            while($row=mysql_fetch_array($pa)){
				 ...
				 <?php
					if(!empty($_POST['valor'])){
						...
						$ncodigot=limpiar($_POST['ncodigot']);
						mysql_query("UPDATE caja_tmp SET ref='$valor' WHERE paciente='$ncodigot' and usu='$usu'");
					}
                	...
                	if(!empty($_POST['buscar'])){
						...
						WHERE (pacientes.id='$buscar' or pacientes.nombre='$buscar')");	
                ...
                <div class="col-md-12">
                    <!-- Advanced Tables -->                 
                        ...
                        <table class="table table-striped">
                            ...
                            ?>
                            <tr>
							 <td><span class="label label-info"> <?php echo $row['paciente']; ?></span></td>                           	                                
                               ...
                               <!-- <td>
                                ...
                                <td>
								<div align="right">
								<a href="#valor<?php echo $row['id']; ?>" role="button" class="btn btn-info"  data-toggle="modal">
										<strong>$ <?php echo formato($valor); ?></strong>
                                    </a>
								</div>
								</td>
                                <td><div align="right">$ <?php echo formato($preciot); ?></div></td>								
                                <td>
                                    <center>                           
								...
								<!--  Modals-->
								 <div class="modal fade" id="valor<?php echo $row['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
								<form name="form1" method="post" action="">
								<div class="modal-dialog">
									<div class="modal-content">
													<div class="modal-header">
														<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>													
														<h3 align="center" class="modal-title" id="myModalLabel">Precio de Consulta</h3>
													</div>
										...
										<div class="row">
											...
											<div class="col-md-6" >											
												<input type="hidden" name="ncodigot" value="<?php echo $row['id']; ?>">
