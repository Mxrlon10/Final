...
font-size: 16px;">Consultorio: <?php echo $nombre_Consultorio; ?> :: Fecha de Acceso : <?php echo fecha(date('Y-m-d')); ?> &nbsp; <a href="../../php_cerrar.php" class="btn btn-danger square-btn-adjust">Salir</a> </div>
        ...
        <div id="page-wrapper" >
			...
			if(!empty($_POST['doc']) and !empty($_POST['nombre'])){
				...
				if($existe==false){
					...
					mysql_query("UPDATE usuario SET nombre='$nombre', cargo='$ncargo', nota='$nota', salario='$salario', estado='$estado', tipo='$tipo', consultorio='$consultorio'
					WHERE doc='$doc'");					
		...
		?>
					...
					<div class="col-md-6">								
								...
								<label>Consultorio/Medico:</label>
