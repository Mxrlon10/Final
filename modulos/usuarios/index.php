												...
												<form name="form2" method="post" enctype="multipart/form-data" action="">											
													<div class="modal-dialog">
														<div class="modal-content">
															...
															<div class="row">                                       
																<div class="col-md-6">																												
																	<input class="form-control" name="doc" placeholder="Usuario" autocomplete="off" required><br>																	
																	<input class="form-control" name="nombre" placeholder="Nombre Completo" autocomplete="off" required><br><br><br>						
