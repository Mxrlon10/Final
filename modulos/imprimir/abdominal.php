...
<?php if(permiso($_SESSION['cod_user'],'3')==TRUE){ ?>
				  <div align="center">
                    <div class="btn-group">
                      ...
                      <a href="#" class="btn btn-info" title="Regresar"><i class="fa fa-list" ></i><strong> Historial</strong></a> 
				...
				<table  width="100%" style="border: 1px solid #660000; -moz-border-radius: 12px;-webkit-border-radius: 12px;padding: 10px;">
					<?php											
						$pa=mysql_query("SELECT * FROM ultra_abdominal WHERE id_consulta='$factura'");				
							while($row=mysql_fetch_array($pa)){
                ...
                <hr/>				
                 <div style="font-size: 14px;"align="center">
                     <strong>INFORME DE ULTRASONOGRAFIA ABDOMINAL</strong><br>                              
                </div> 
                <hr/>				
                <hr/>
                    <!-- /. TABLA  -->
                    ...
                    <!-- Advanced Tables -->                    
                            ...
                            <table class="table table-striped table-bordered table-hover" width="100%" style="font-size: 14px; border: 1px solid #660000; -moz-border-radius: 12px;-webkit-border-radius: 12px;padding: 10px;">
			                 <tr>
			                    ...
			                    <!-- Advanced Tables -->                                           				
											             <dl>
														  <dt><strong>HIGADO:</strong></dt>
														  <dd><?php echo $row['higado']; ?>.</dd><br>
														  <dt><strong>VESICULA BILIAR:</strong></dt>
														  <dd><?php echo $row['vesicula']; ?>.</dd><br>
														  <dt><strong>PANCREAS:</strong></dt>
														  <dd><?php echo $row['pancreas']; ?>.</dd><br>
														  <dt><strong>BAZO:</strong></dt>
														  <dd><?php echo $row['bazo']; ?>.</dd><br>
														  <dt><strong>RIÑON DERECHO:</strong></dt>
														  <dd><?php echo $row['riñond']; ?>.</dd><br>
														  <dt><strong>RIÑON IZQUIERDO:</strong></dt>
														  <dd><?php echo $row['riñoni']; ?>.</dd><br>
														  <dt><strong>VEJIGA:</strong></dt>
														  <dd><?php echo $row['vejiga']; ?>.</dd><br>
														  <dt><strong>OBSERVACIONES:</strong></dt>
														  <dd><?php echo $row['observaciones']; ?>.</dd><br>
														</dl>											                  																												
													<?php } ?>
													<div align="right">
							                        <strong>F.________________________________</strong><br>
