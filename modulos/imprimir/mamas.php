...
<?php if(permiso($_SESSION['cod_user'],'3')==TRUE){ ?>
         <div align="center">
                    <div class="btn-group">
                      <a href="../consultas_medicas/index.php" class="btn btn-default" title="Regresar"><i class="fa fa-arrow-left" ></i><strong> Regresar</strong></a>
                      <a href="#" class="btn btn-default" title="Regresar"><i class="fa fa-list" ></i><strong> Historial</strong></a> 
				...
				<table  width="100%" style="border: 1px solid #660000; -moz-border-radius: 12px;-webkit-border-radius: 12px;padding: 10px;">
					<?php											
					   $pa=mysql_query("SELECT * FROM ultra_mamas WHERE id_consulta='$factura'");				
						while($row=mysql_fetch_array($pa)){
                ...
                <hr/>				
                 <div style="font-size: 14px;"align="center">
                     <strong>INFORME DE ULTRASONIDO DE MAMAS</strong><br>                              
                </div> 
                <hr/>				
                <hr/>
                    <!-- /. TABLA  -->
                       <div style="font-size: 12px;">
						...
						<div align="right">
                        <strong>MEDICO: </strong><?php echo $nombre_medico; ?><br><br>
						</div>
						</div>
						<hr/>
            <div class="row">
				...
				<table class="table table-striped table-bordered table-hover" width="100%" style="font-size: 14px; border: 1px solid #660000; -moz-border-radius: 12px;-webkit-border-radius: 12px;padding: 10px;">
                 <tr>
                    ...
                    <!-- Advanced Tables -->                                           				
								             <dl>
											  <dt><strong>RESULTADO:</strong></dt>
											  <dd><?php echo $row['informe']; ?>.</dd><br>
											  <dt><strong>DX:</strong></dt>
											  <dd><?php echo $row['dx']; ?>.</dd><br>
											</dl>											                  																												
										<?php } ?>
										<div align="right">
