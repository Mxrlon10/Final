...
<?php if(permiso($_SESSION['cod_user'],'3')==TRUE){ ?>
          <div align="center">
				...
				<table  width="100%" style="border: 1px solid #660000; -moz-border-radius: 12px;-webkit-border-radius: 12px;padding: 10px;">
					<?php											
						$pa=mysql_query("SELECT * FROM ultra_prostata WHERE id_consulta='$factura'");				
							while($row=mysql_fetch_array($pa)){
                ...
                <hr/>				
                 <div style="font-size: 14px;"align="center">
                     <strong>ECOGRAFIA PROSTATICA</strong><br>                              
                </div> 
                <hr/>
                    <!-- /. TABLA  -->
                 ...
                 <tr>
                    ...
                    <!-- Advanced Tables -->                                           				
								             <dl>
											  ...
											  <dt><strong>PROSTATA:</strong></dt>
											  <dd><?php echo $row['prostata']; ?>.</dd><br>
											  <dt><strong>CONCLUSIÓN:</strong></dt>
											  <dd><?php echo $row['conclusion']; ?>.</dd><br>
											</dl>											                  																												
										<?php } ?>
                    <div align="right">
