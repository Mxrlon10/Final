...
<?php if(permiso($_SESSION['cod_user'],'3')==TRUE){ ?>
				...
				<table  width="100%" style="border: 1px solid #660000; -moz-border-radius: 12px;-webkit-border-radius: 12px;padding: 10px;">
					<?php											
						$pa=mysql_query("SELECT * FROM ultra_ginecologica WHERE id_consulta='$factura'");				
							while($row=mysql_fetch_array($pa)){
                ...
                <hr/>				
                 <div style="font-size: 14px;"align="center">
                     <strong>INFORME DE ULTRASONOGRAFIA GINECOLOGICA</strong><br>                              
                </div> 
                <hr/>				
                <hr/>	
                    ...
                    <!-- Advanced Tables -->                    
                            ...
                            <table class="table table-striped table-bordered table-hover" width="100%" style="font-size: 14px; border: 1px solid #660000; -moz-border-radius: 12px;-webkit-border-radius: 12px;padding: 10px;">
			                 <tr>
			                    ...
			                    <!-- Advanced Tables -->                                           				
											             <dl>
														  <dt><strong>UTERO:</strong></dt>
														  <dd><?php echo $row['utero']; ?>.</dd><br>
														  <dt><strong>ENDOMETRIO:</strong></dt>
														  <dd><?php echo $row['endometrio']; ?>.</dd><br>
														  <dt><strong>ANEXOS:</strong></dt>
														  <dd><?php echo $row['anexo']; ?>.</dd><br>
														  <dt><strong>FONDO DEL SACO DE DOUGLAS:</strong></dt>
														  <dd><?php echo $row['saco']; ?>.</dd><br>
