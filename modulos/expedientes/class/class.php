...
class Proceso_Consulta{
	...
	function crear(){
		...
		mysql_query("INSERT INTO consultas_medicas (id_paciente, id_medico,consultorio,sintomas, diagnostico,tratamiento,observaciones,fecha,hora,status,tipo,ant_per,ant_fm,peso,talla,ta,sc,pc,exlab,vista)	
							              VALUES ('$id_general','$id_medico','$id_consultorio','$consulta','QUITAR','$tratamiento','$observaciones','$fecha','$hora','$status','$tipo','$ant_per','$ant_fm','$peso','$talla','$ta','$sc','$pc','$exlab','n')");
		...
		mysql_query("Update consultas_medicas  Set status='PROCESADO' Where id_paciente='$id_general'");
	}
