                            ...
                            <div class="table-responsive">								
                                ...
                                <table class="table table-bordered" width="100%"  style="border: 1px solid #660000; -moz-border-radius: 10px;-webkit-border-radius: 12px;padding: 10px;">
                                    <tr><td>
                                            ...
                                            <thead>
                                                <tr>
                                                    <td colspan="4"><strong>FACTURA: <?php echo $row['factura']; ?> <?php echo fecha($row['fecha']).' '.$row['hora']; ?></strong></td>
                                                </tr> 
                                                <tr>
                                                    <th>CODIGO</th>                                                                                                                                                                           
                                                    <th>PACIENTE</th>                                                                                                                                                                                                                                                                                                                                                       
                                            ...
                                            <tbody>
                                                 <?php
                                                    $neto=0;
                                                    $pax=mysql_query("SELECT * FROM detalle WHERE factura='$url' ORDER BY nombre");              
