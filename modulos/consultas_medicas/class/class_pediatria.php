...
#tabla pediatria_enf
	...
	function __construct($id,$nombre,$direccion,$telefono,$edad,$lugar,$padre,$madre,$sexo,$obstetra,$referido,$estado,$id_pediatria,$id_consultorio,
						#tabla pediatria_hf
		...
		$this->estado=$estado;
		$this->id_pediatria=$id_pediatria;		
	...
	function crear(){
		...
		$estado=$this->estado;
		$id_pediatria=$this->id_pediatria;	
		...
		mysql_query("INSERT INTO pediatria (id_paciente,nombre, edad, lugar, padre, madre,  sexo, obstetra, referido, estado, consultorio) 
					VALUES ('$id_pediatria','$nombre','$edad','$lugar','$padre','$madre','$sexo','$obstetra','$referido','$estado','$id_consultorio')");
		
		mysql_query("INSERT INTO pediatria_hf (id_paciente, padrehf, edadpdre, madrehf, edadmdre, hermanohf, edadhno, hermanahf, edadhna, tuberculosis, diabetes, 
													alergia, convulsioneshf, congenicas, otroshf, consultorio) 
							          VALUES ('$id_pediatria','$padrehf','$edadpdre','$madrehf','$edadmdre','$hermanohf','$edadhno','$hermanahf','$edadhna','$tuberculosis','$diabetes',
												   '$alergia','$convulsioneshf','$congenicas','$otroshf','$id_consultorio')");
			
		mysql_query("INSERT INTO pediatria_drllo (id_paciente, termino, parto, rh, con_nac, peso_nac, talla_nac, con_semana, alimentacion, cianosis, sento, 
													paro, convulsiones, camino, palabras, ictericia, diente, fraces, apga, vesical,	instestinos, consultorio) 
						                  VALUES ('$id_pediatria','$termino','$parto','$rh','$con_nac','$peso_nac','$talla_nac','$con_semana','$alimentacion','$cianosis','$sento',
													'$paro','$convulsiones','$camino','$palabras','$ictericia','$diente','$fraces','$apga','$vesical','$instestinos','$id_consultorio')");
		
		mysql_query("INSERT INTO pediatria_alim (id_paciente, pecho, formula, vitaminas, suaves, dieta, habitos, vomitos, colicos, consultorio) 
											  VALUES ('$id_pediatria','$pecho','$formula','$vitaminas','$suaves','$dieta','$habitos','$vomitos','$colicos','$id_consultorio')");
			
		mysql_query("INSERT INTO pediatria_enf (id_paciente, tosferina, apendicitis, sarampion, reumatica, rubeola, otitis, paperas, irs, varicela, amigdalitis,
													escarlatina, convulsionesx, difteria, constipacion, operaciones, diarrea, amebiasis, otrosenf, consultorio) 
										   VALUES ('$id_pediatria','$tosferina','$apendicitis','$sarampion','$reumatica','$rubeola','$otitis','$paperas','$irs','$varicela','$amigdalitis',
