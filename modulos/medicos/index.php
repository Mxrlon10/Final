<?php 
	...
	if(!empty($_GET['del'])){
		$id=$_GET['del'];
		mysql_query("DELETE FROM medicos WHERE id='$id'");
		header('index.php');
	}
?>
											...
											<div class="modal-dialog">
												<div class="modal-content">
													<div class="modal-header">
														...
														<h3 align="center" class="modal-title" id="myModalLabel">Nuevo Médico</h3>
													</div>
										<div class="panel-body">
										<div class="row">											
											<div class="col-md-12">
											...
											<div class="col-md-6">													
												...
												<input class="form-control" name="especialidad" title="Se necesita una Especialidad" placeholder="Especialidad" autocomplete="off" required><br>																							 
                            ...
                            <div class="table-responsive">
								<?php 
									if(!empty($_POST['nombre'])){ 
										...
										if(empty($_POST['id'])){
											$oPaciente=new Proceso_Paciente('',$nombre,$direccion,$telefono,$sexo,$email,$estado,$id_consultorio,$especialidad);
											$oPaciente->crear();
											echo mensajes('Médico "'.$nombre.'" Creado con Exito','verde');
										}else{
											$id=limpiar($_POST['id']);
											$oPaciente=new Proceso_Paciente($id,$nombre,$direccion,$telefono,$sexo,$email,$estado,$id_consultorio,$especialidad);
											$oPaciente->actualizar();
											echo mensajes('Médico "'.$nombre.'" Actualizado con Exito','verde');
										}
									}
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
										<?php
											$editar=0; 											
											$pame=mysql_query("SELECT * FROM medicos WHERE consultorio='$id_consultorio' ORDER BY nombre");													
										...
										<div class="row">
											...
											<div class="col-md-6">																			
												...
												<div class="input-group">
												  ...
												  <input class="form-control" type="email" name="email" autocomplete="off" value="<?php echo $row['email']; ?>"><br>												
												</div><br>								
											</div>
											<div class="col-md-6">																																		
												<div class="input-group">
												...
												<div class="input-group">
												  ...
												  <input class="form-control" title="Se necesita una Especialidad"  name="especialidad" placeholder="Especialidad" value="<?php echo $row['especialidad']; ?>" autocomplete="off" required><br>											
											</div><br>													
												<div class="input-group">
												...
												<div class="modal-header">
													...
													<div class="panel-body">
														...
														<div class="alert alert-danger">
																	...
																	una vez Eliminado el médico [ <?php echo $row['nombre']; ?> ]<br> 
