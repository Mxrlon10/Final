                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h3 align="center" class="modal-title" id="myModalLabel">Nuevo Estado</h3>
                                        </div>
														...
														<div class="modal-content">
															...
															<div class="row" align="center">                                       
																...
																<div class="alert alert-danger">
																	...
																	una vez Eliminado el estado <strong>[ <?php echo $row['nombre']; ?> ]</strong> no podra ser Recuperado.</h4>
																</div>																																																																																																								
															</div> 
															</div> 
															<div class="modal-footer">
