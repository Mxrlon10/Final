...
font-size: 16px;">Consultorio: <?php echo $nombre_Consultorio; ?> :: Fecha de Acceso : <?php echo fecha(date('Y-m-d')); ?> &nbsp; <a href="../../php_cerrar.php" class="btn btn-danger square-btn-adjust">Salir</a> </div>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">						               
                 ...
                 <div align="center">
					<div class="btn-group">
					  <a href="../pagos/index.php?id=<?php echo $url; ?>" class="btn btn-danger" title="Pagos"><i class="fa fa-dollar" ></i><strong> Pagos</strong></a> 
                                ...
                                <table class="table table-striped table-bordered table-hover"  width="100%" style="border: 1px solid #660000; -moz-border-radius: 12px;-webkit-border-radius: 12px;padding: 10px;">                                    
									<thead>
                                        <tr>
                                            <th>CODIGO</th>                                                                                                                                                                           
                                            <th>PACIENTE</th>                                                                                                                                                                                                                                                                                                                                                       
                                            <th><div align="right">COSTO DE CONSULTA</div></th>
                                    ...
                                    <tbody>
										 <?php
										  ...
										  ?>
                                        <tr>
											<td><div align="center"><span class="label label-info"><?php echo $row['codigo']; ?></span></div></td>
