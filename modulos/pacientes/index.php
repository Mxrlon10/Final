<?php 
	...
	if(!empty($_GET['del'])){
	 ...
	 #paginar
        ...
        $cans=mysql_query("SELECT COUNT(nombre)as total FROM pacientes");
                                        ...
                                        <form method="post" action="" enctype="multipart/form-data" name="form1" id="form1">
                                          <div class="input-group">
                                                 <input class="form-control" name="bus" type="text" class="span2" size="60" list="browsers1" autocomplete="off" placeholder="Buscar" autofocus>
                                                  ...
                                                  <?php
                                                    $buscar=$_POST['bus'];
                                                    $can=mysql_query("SELECT * FROM pacientes"); 
                                ...
                                <table class="table table-striped table-bordered table-hover" style="font-size:12px; font-family:Times New Roman;">
                                    ...
                                    <tbody>
										<?php
											...
											if(empty($_POST['bus'])){
                                                $pame=mysql_query("SELECT * FROM pacientes WHERE consultorio='$id_consultorio' ORDER BY nombre LIMIT $inicio, $maximo");
                                            }else{
                                                $buscar=$_POST['bus'];
                                                $pame=mysql_query("SELECT * FROM pacientes where nombre LIKE '$buscar%' 
                                                 or id LIKE '$buscar%'");
                                            }      													
