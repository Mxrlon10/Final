...
font-size: 16px;">Consultorio: <?php echo $nombre_Consultorio; ?> :: Fecha de Acceso : <?php echo fecha(date('Y-m-d')); ?> &nbsp; <a href="../../php_cerrar.php" class="btn btn-danger square-btn-adjust">Salir</a> </div>
  ...
  <FORM action="<?php echo $_SERVER['PHP_SELF']?>" method="GET" >
   <div class="col-md-6">
    <INPUT type="hidden" class="form-control" name="host" id ="host" value="localhost">
   <INPUT type="hidden" class="form-control" name="bd" id ="bd" value="consultoriopediatria"><br />
   </div>
   <div class="col-md-6">
